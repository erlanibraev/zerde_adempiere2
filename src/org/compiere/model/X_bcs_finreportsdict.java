...
/** Generated Model for bcs_finreportsdict
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_bcs_finreportsdict extends PO implements I_bcs_finreportsdict, I_Persistent 
{
    ...
    public X_bcs_finreportsdict (Properties ctx, int bcs_finreportsdict_ID, String trxName)
    {
      super (ctx, bcs_finreportsdict_ID, trxName);
      /** if (bcs_finreportsdict_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_bcs_finreportsdict (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_bcs_finreportsdict[")
