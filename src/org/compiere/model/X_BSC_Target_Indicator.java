...
/** Generated Model for BSC_Target_Indicator
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_BSC_Target_Indicator extends PO implements I_BSC_Target_Indicator, I_Persistent 
{
    ...
    public X_BSC_Target_Indicator (Properties ctx, int BSC_Target_Indicator_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_BSC_Target_Indicator (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_BSC_Target_Indicator[")
	...
	/** Set BSC NetWork Diagram Sub Line Target Indicator ID.
		@param BSC_Target_Indicator_ID BSC NetWork Diagram Sub Line Target Indicator ID	  */
	public void setBSC_Target_Indicator_ID (int BSC_Target_Indicator_ID)
	{
		if (BSC_Target_Indicator_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_BSC_Target_Indicator_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_BSC_Target_Indicator_ID, Integer.valueOf(BSC_Target_Indicator_ID));
	}

	/** Get BSC NetWork Diagram Sub Line Target Indicator ID.
		@return BSC NetWork Diagram Sub Line Target Indicator ID	  */
	public int getBSC_Target_Indicator_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_BSC_Target_Indicator_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
