...
/** Generated Model for PFR_GroupBy
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_PFR_GroupBy extends PO implements I_PFR_GroupBy, I_Persistent 
{
    ...
    public X_PFR_GroupBy(Properties ctx)
    { 
      super (ctx, null, null);
    } 

    /** Standard Constructor */
    public X_PFR_GroupBy (Properties ctx, int PFR_GroupBy_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_PFR_GroupBy (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_PFR_GroupBy[")
	...
	/** Set PFR_GroupBy ID.
		@param PFR_GroupBy_ID PFR_GroupBy ID	  */
	public void setPFR_GroupBy_ID (int PFR_GroupBy_ID)
	{
		if (PFR_GroupBy_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_PFR_GroupBy_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_PFR_GroupBy_ID, Integer.valueOf(PFR_GroupBy_ID));
	}

	/** Get PFR_GroupBy ID.
		@return PFR_GroupBy ID	  */
	public int getPFR_GroupBy_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_PFR_GroupBy_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
